<x-app-layout>
    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex flex-row rounded-lg border border-gray-200/80 bg-white p-6">
            <!-- Avaar Container -->
            <div class="relative">
                <!-- User Avatar -->
                <img class="w-40 h-40 rounded-md object-cover" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
                    alt="User" />
            ...
            <div class="flex flex-col px-6">
                ...
                <div class="mt-2 flex flex-row items-center space-x-5">
                    <!-- Comments -->
                    <a href="#"
                    class="hidden sm:flex h-20 w-40 flex-col items-center justify-center rounded-md border border-dashed border-gray-200 transition-colors duration-100 ease-in-out hover:border-gray-400/80">
                ...
                <a href="{{ route('profile.show') }}" class="text-center mt-5 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Compléter votre profil</a>
